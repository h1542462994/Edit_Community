...
+ 主要功能
	+ 将当天的作业显示在6个**RichTextBox**中. ![](https://github.com/h1542462994/Edit_Community/Picture/main.jpg)
	+ 支持编辑文本的字号,字体,加粗,倾斜,颜色.**只需要选中文字并松开左键即可** ![](https://github.com/h1542462994/Edit_Community/Picture/editbox.jpg)
		+ 如需修改预设字体颜色,只要右键颜色即可,将会跳出`ColorDialog`
	+ 通过左键单击左下角区域来切换当前显示的文件夹.
		+ 如果要编辑模板,可以按如图所示操作 ![](https://github.com/h1542462994/Edit_Community/Picture/setting1.jpg)
...
+ 扩展功能
	...
	```		
# 注意事项
+ 代码下载:该软件引用HTLibrary库,点击跳转[](https://github.com/h1542462944/HTLibrary)
# 历史
